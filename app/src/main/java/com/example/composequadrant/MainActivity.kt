...
@Composable
fun Quadrant(title: String, subtitle: String, backgroundColor: Color, modifier: Modifier = Modifier) {
    Column(modifier = modifier.fillMaxSize().background(backgroundColor)
        .padding(16.dp),
        verticalArrangement = Arrangement.Center,
        horizontalAlignment = Alignment.CenterHorizontally) {
        QuadrantTitle(title = title)
        QuadrantSubtitle(subtitle = subtitle)
    }
}
...
@Composable
fun QuadrantSubtitle(subtitle: String) {
